...
function Nav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "nav",
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-card border-b border-border shadow-subtle backdrop-blur-sm" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-accent flex items-center justify-center text-accent-foreground font-display font-bold text-sm", children: "AJ" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `relative pb-1 text-sm font-medium font-display transition-colors duration-200 group ${activeSection === link.href.slice(1) ? "text-foreground" : "text-muted-foreground hover:text-foreground"}`,
                  children: [
                    link.label,
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `absolute bottom-0 left-0 w-full h-[2px] bg-accent origin-left transition-transform duration-300 ${activeSection === link.href.slice(1) ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`
                      }
                    )
                  ]
                },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-5 flex flex-col gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "nav",
          {
            ...
            children: [
              navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => scrollTo(link.href),
                  className: `text-left py-3 text-sm font-medium font-display border-b border-border last:border-0 transition-colors duration-200 ${activeSection === link.href.slice(1) ? "text-accent" : "text-muted-foreground"}`,
                  children: link.label
                },
                link.href
              )),
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 lg:px-8 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 bg-accent flex items-center justify-center text-accent-foreground font-display font-bold text-xs", children: "AJ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-semibold text-foreground", children: "Aditi Jadhav" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Aspiring Software Developer" }) })
    ] }) }) })
  ] });
}
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ref: headingRef,
          className: `transition-all duration-700 ease-out ${headingInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-4", children: "01 / About" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-heading mb-8", children: "About Me" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          ref: textRef,
          className: `space-y-5 text-muted-foreground leading-relaxed transition-all duration-700 ease-out delay-150 ${textInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "I am a first-year Computer Science student at",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Indira College of Engineering and Management, Pune" }),
              "."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "My journey into software development is built on",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "discipline, consistency, and a strong sense of direction" }),
              ". While my path is not traditional, it has shaped my approach to learning and problem-solving with focus and structure."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "I am currently strengthening my foundation in programming and problem solving, with a clear goal of growing into a skilled and reliable software developer." })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: statsRef, className: "grid grid-cols-2 gap-4", children: stats.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: { transitionDelay: `${i * 100}ms` },
        className: `border border-border bg-background p-5 group hover:border-accent transition-all duration-500 ease-out ${statsInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-4"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-2", children: stat.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-lg leading-tight", children: stat.value }),
...
${form.message}`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        className: `mb-14 transition-all duration-700 ease-out ${headingInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-4", children: "05 / Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-heading", children: "Get In Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-4 max-w-lg", children: "I'm open to conversations about opportunities, collaborations, or just connecting with others in tech." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: linksRef, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold font-display text-muted-foreground tracking-wider uppercase mb-6", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: socialLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: link.href,
            ...
            className: `flex items-center gap-4 p-4 border border-border bg-background hover:border-accent group transition-all duration-500 ease-out ${linksInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-6"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 border border-border group-hover:border-accent group-hover:bg-accent/5 flex items-center justify-center text-muted-foreground group-hover:text-accent font-mono text-xs font-bold transition-all duration-200 flex-shrink-0", children: link.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-section-label mb-0.5", children: link.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm text-foreground group-hover:text-accent transition-colors duration-200 truncate", children: link.value })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-muted-foreground group-hover:text-accent transition-colors duration-200 text-xs", children: "→" })
            ]
          },
          link.label
        )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          ref: formRef,
          className: `transition-all duration-700 ease-out delay-200 ${formInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold font-display text-muted-foreground tracking-wider uppercase mb-6", children: "Send a Message" }),
            submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent font-display font-semibold text-lg", children: "Message prepared!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-2", children: "Your mail client should open momentarily." })
                ]
              }
    ...
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            ref,
            className: `mb-14 transition-all duration-700 ease-out ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-4", children: "04 / Education" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-heading", children: "Education" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-6 top-0 bottom-0 w-px bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: education.map((edu, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedCard, { delay: index2 * 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `absolute left-2 md:left-4 top-5 w-4 h-4 border-2 flex items-center justify-center ${edu.status === "Pursuing" ? "border-accent bg-accent" : "border-border bg-background"}`,
                    children: edu.status === "Pursuing" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 bg-accent-foreground" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border bg-card p-6 hover:border-accent group transition-colors duration-200", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground group-hover:text-accent transition-colors duration-200", children: edu.degree }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: edu.institution }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: edu.location })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start sm:items-end gap-1.5 flex-shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `text-xs px-2.5 py-1 font-mono font-semibold border ${edu.status === "Pursuing" ? "border-accent text-accent bg-accent/5" : "border-border text-muted-foreground"}`,
                          children: edu.status
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono", children: edu.period })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-3", children: edu.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
...
function AnimatedCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      className: `transition-all duration-700 ease-out ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-6"}`,
      children
    }
  );
}
...
function Goals() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "goals", className: "py-24 bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        className: `mb-14 transition-all duration-700 ease-out ${headingInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-4", children: "03 / Goals" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-heading", children: "Goals" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: gridRef, className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: goals.map((goal, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": `goal-${goal.index}`,
        style: { transitionDelay: `${i * 100}ms` },
        className: `border border-border bg-background p-6 group hover:border-accent transition-all duration-500 ease-out hover:shadow-elevated ${gridInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-accent font-semibold tabular-nums flex-shrink-0 mt-1", children: goal.index }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground mb-2 group-hover:text-accent transition-colors duration-200", children: goal.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: goal.desc })
          ] })
        ] })
      },
      goal.index
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(circle, oklch(0.68 0.22 248 / 0.06) 0%, transparent 70%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-6 lg:px-8 w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center lg:items-start text-center lg:text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "h1",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Jadhav" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Aspiring Software Developer"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "Aiming for excellence in software with patience and consistency."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-display tracking-widest uppercase", children: "Scroll" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gradient-to-b from-border to-transparent" })
              ]
            }
          )
        ] })
...
function Skills() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-24 bg-background border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: headingRef,
        className: `mb-14 transition-all duration-700 ease-out ${headingInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-section-label mb-4", children: "02 / Skills" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-section-heading", children: "Skills & Strengths" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: strengthsRef, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold font-display text-muted-foreground tracking-wider uppercase mb-6 border-b border-border pb-3", children: "Core Strengths" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: coreStrengths.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `skill-strength-${i}`,
            style: { transitionDelay: `${i * 80}ms` },
            className: `flex items-start gap-4 p-4 border border-border bg-card hover:border-accent group transition-all duration-500 ease-out ${strengthsInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-6"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: s.name }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: techRef, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold font-display text-muted-foreground tracking-wider uppercase mb-6 border-b border-border pb-3", children: "Technical Skills" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: technicalSkills.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `skill-tech-${i}`,
            style: { transitionDelay: `${i * 80}ms` },
            className: `border border-border bg-card p-4 hover:border-accent group transition-all duration-500 ease-out ${techInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm leading-tight", children: s.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `inline-block mt-2 text-xs px-2 py-0.5 font-mono border ${s.color === "accent" ? "border-accent text-accent bg-accent/5" : "border-border text-muted-foreground"}`,
                  children: s.level
                }
              )
            ]
